...
MODULE_AUTHOR("Roman Chang & Aniket Das");
...
typedef struct osprd_info {
    ...
    unsigned int nReadLocks;        // Keep track of number of processes
                                    // with read locks on the device
...
// last copy is closed.)
static int osprd_release(struct inode *inode, struct file *filp)
{
    if (filp) {
